    ...
    for i in range(len(sections)):
        for j in range(len(sections)):
            ...
            conflictsa = cur.execute(
                '''SELECT COUNT(*) FROM Con_Section_Section WHERE SectionID1 = ? AND SectionID2 = ?''', (a, b))
            conflictsa = cur.fetchall()
            conflictsa = conflictsa[0][0]
            conflictsb = cur.execute(
                '''SELECT COUNT(*) FROM Con_Section_Section WHERE SectionID1 = ? AND SectionID2 = ?''', (b, a))
            ...
            # same class name
            prefa = cur.execute('''SELECT COUNT(*) FROM Pref_Section_Section WHERE SectionID1 = ? AND SectionID2 = ?''',
                                (a, b))
            prefa = cur.fetchall()[0][0]
            prefb = cur.execute('''SELECT COUNT(*) FROM Pref_Section_Section WHERE SectionID1 = ? AND SectionID2 = ?''',
                                (b, a))
            ...
            # same professor
            pref2a = cur.execute(
                '''SELECT COUNT(*) FROM Pref2_Section_Section WHERE SectionID1 = ? AND SectionID2 = ?''', (a, b))
            pref2a = cur.fetchall()[0][0]
            pref2b = cur.execute(
                '''SELECT COUNT(*) FROM Pref2_Section_Section WHERE SectionID1 = ? AND SectionID2 = ?''', (b, a))
